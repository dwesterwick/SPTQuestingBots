...
namespace QuestingBots.Configuration
{
    ...
    public class LimitInitialBossSpawnsConfig
    {
        ...
        [DataMember(Name = "disable_rogue_delay", IsRequired = true)]
        public bool DisableRogueDelay { get; set; } = true;

        [DataMember(Name = "max_initial_bosses", IsRequired = true)]
        public int MaxInitialBosses { get; set; } = 10;

        [DataMember(Name = "max_initial_rogues", IsRequired = true)]

...
namespace SPTQuestingBots.Patches
{
    public class IsFollowerSuitableForBossPatch : ModulePatch
    {
        ...
        protected static bool PatchPrefix(ref bool __result, BotBoss __instance, BotOwner offer)
        {
            ...
            Controllers.LoggingController.LogInfo(__instance.Owner.GetText() + "'s group contains: " + string.Join(",", bossGroupMemberProfiles.Select(m => m.Nickname)));
            Controllers.LoggingController.LogInfo(offer.GetText() + "'s group contains: " + string.Join(",", offerGroupMemberProfiles.Select(m => m.Nickname)));

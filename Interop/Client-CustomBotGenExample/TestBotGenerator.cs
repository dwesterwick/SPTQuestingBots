...
{
    public class TestBotGenerator : QuestingBots.Components.Spawning.BotGenerator
    {
        public static int DistanceToSpawnFromMainPlayer { get; } = 5;
        public static int BotsToCache { get; } = 10;

        private QuestingBots.Components.LocationData locationData;
        ...
        protected override void Init()
        {
            ...
            locationData = Singleton<GameWorld>.Instance.GetComponent<QuestingBots.Components.LocationData>();
        ...
        protected override async Task<QuestingBots.Models.BotSpawnInfo> GenerateBotGroupTask()
        {
            return await GenerateBotGroup(WildSpawnType.assault, BotDifficulty.normal, 1);
        }

        protected override IEnumerable<Vector3> GetSpawnPositionsForBotGroup(QuestingBots.Models.BotSpawnInfo botGroup)
        {
